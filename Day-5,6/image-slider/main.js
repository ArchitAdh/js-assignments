...
function Slider(id = "slider") {
  let currentIndex = 0;
  const slider = document.getElementById(id);

  //inside the div slider create left and right buttons
...
`;
  ...
  slider.appendChild(sliderLeftButton);
  slider.appendChild(sliderRightButton);
  ...
  function slide(slideDirection = -1) {
    //slides div
    ...
    const nextIndex =
      (currentIndex - slideDirection + numOfSlides) % numOfSlides;
